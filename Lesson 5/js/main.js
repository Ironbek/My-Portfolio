let open = document.getElementById('open-btn'),
	...
	input_value = document.getElementsByTagName('input');
...
// Не полностью реализованная дисконтная система
	...
	if (mainList.discount == true){
		...
		discount_value.style.backgroundColor = '#0bcb2d'
	} else {

		discount_value.style.backgroundColor = '#e61313'
	}
...
choose_item.addEventListener('change', () => {
	let items = choose_item.value;
		...
		items_value.textContent = shopItems; 
	}
});
	...
	console.log('Такого не может быть');
	 mainList.open = false;  
		...
		if (mainList.open == true) {
			isopen_value.style.backgroundColor = '#0bcb2d'
		}   else {

			isopen_value.style.backgroundColor = '#e61313'
		}
